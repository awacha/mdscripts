...
class Ui_RamaAnalyzerMain(object):
    def setupUi(self, RamaAnalyzerMain):
        ...
        RamaAnalyzerMain.resize(1049, 451)
        ...
        self.residuesListView = QtWidgets.QTreeView(self.widget)
        ...
        self.stepByStepGroupBox.setChecked(False)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.movieDelaySpinBox.sizePolicy().hasHeightForWidth())
        self.movieDelaySpinBox.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.skipFramesSpinBox.sizePolicy().hasHeightForWidth())
        self.skipFramesSpinBox.setSizePolicy(sizePolicy)
        ...
        self.verticalLayout_6.addWidget(self.widget_4, 0, QtCore.Qt.AlignVCenter)
    ...
    def retranslateUi(self, RamaAnalyzerMain):
        ...
        self.hideAllPushButton.setText(_translate("RamaAnalyzerMain", "Hide all"))
        ...
        self.label_2.setText(_translate("RamaAnalyzerMain", "<html><head/><body><p>Movie delay:</p></body></html>"))
